<?php
	/**
	* Template Name: Full - Menu2 - Lighter
	*
	* @author CoronaThemes
	* @package Bolder
	* @since 1.0.0
...
$class .= ' lighter-overlay';
$logo_image = get_template_directory_uri().'/assets/images/logo-dark.png';
...
//custom css menu 2
add_action( 'wp_enqueue_scripts', 'demo_solarize_get_custom_css', 99 );
