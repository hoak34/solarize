...
if ( ! empty( $parallax ) ) {
    ...
    if( strpos( $parallax, 'fixed' ) !== false ){
        $css_classes[] = 'js-vc_parallax-o-fixed';
        $wrapper_attributes[] = 'data-vc-parallax="1"';
    }
    else
    {
...
$output .= '<div ' . implode( ' ', $wrapper_attributes ) . '>';
    if($color_overlay !=''){
        $output .= '<div class="solarize-overlay" style="background:'.$color_overlay.'"></div>';
    }
