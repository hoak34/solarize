...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
			...
			array(
				'name'     				=> 'Solarize common', // The plugin name
				'slug'     				=> 'solarize-common', // The plugin slug (typically the folder name)
				'source'   				=> get_template_directory_uri() . '/includes/plugins/solarize-common.zip', // The plugin source
				'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
